	...
	<div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-success btn-sm bg-gradient-success btn-flat" form="request-form"><i class="fa fa-save"></i> Save</button>
				<a class="btn btn-danger btn-sm bg-gradient-success border btn-flat" href="./?page=requests"><i class="fa fa-angle-left"></i> Cancel</a>
			</div>
		</div>
	</div>
</div>
