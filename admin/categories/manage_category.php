	...
	<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-success btn-sm bg-gradient-success btn-flat" form="category-form"><i class="fa fa-save"></i> Save</button>
				<a class="btn btn-danger btn-sm bg-gradient-danger border btn-flat" href="./?page=categories"><i class="fa fa-times"></i> Cancel</a>
			</div>
		</div>
	</div>
</div>
