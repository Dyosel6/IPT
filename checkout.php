...
<section class="py-3">
    <div class="container">
        <div class="content px-3 py-5 bg-gradient-yellow">
                        ...
                        ?>
                            <form action="" id="order-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="contact" id="contact" cols="30" rows="1" class="form-control form-control-sm rounded-0" required></textarea>
                                </div>
                                <div class="py-1 text-center">
                                    <button class="btn btn-lg btn-deafault text-light bg-gradient-green col-lg-4 col-md-6 col-sm-12 col-xs-12 rounded-pill">Place Order</button>
                                </div>
                            </form>
                        </div>
                    </div>
