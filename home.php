                ...
                <div class="card card-outline rounded-0">
                    <div class="card-body">
                        ...
                        <div class="text-center py-1">
                            <a href="./?p=products" class="btn btn-lg btn-deafault text-light bg-gradient-yellow col-lg-4 col-md-6 col-sm-12 col-xs-12 rounded-pill">Explore More Product</a>
                        </div>
                    </div>
                </div>
            </div>
